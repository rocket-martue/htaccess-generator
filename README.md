...
- CSP（Content-Security-Policy）— ディレクティブ個別設定（default-src / script-src / style-src 等）、wp-admin / wp-login.php への自動分岐出力（管理画面用に unsafe-inline / unsafe-eval を自動付与）、Report-Only モード対応
