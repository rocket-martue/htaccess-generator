...
export default {
	...
	'preset.performance.label': 'Performance + Security Headers',
	'preset.performance.desc': 'Combines caching/compression with security headers',
	'preset.headers-only.label': 'Security Headers Only',
	'preset.headers-only.desc': 'Enable only security response headers',
	'preset.cache-only.label': 'Performance Focused',
	'preset.cache-only.desc': 'Enable only cache/compression settings',
